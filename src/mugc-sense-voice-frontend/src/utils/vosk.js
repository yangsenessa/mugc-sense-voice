(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) :
        typeof define === 'function' && define.amd ? define(['exports'], factory) :
            (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Vosk = {}));
    ...
    function createStaticWorkerFactory(workerPath) {
        return function WorkerFactory(options) {
            return new Worker(workerPath, options);
        };
    }

    const WorkerFactory = createStaticWorkerFactory('models/vosk.js');
    ...
    class Model extends EventTarget {
        ...
        get KaldiRecognizer() {
            ...
            return class extends EventTarget {
                ...
                on(event, listener) {
                    this.addEventListener(event, (event) => {
                        listener(event === null || event === void 0 ? void 0 : event.detail);
                    });
                }
                setWords(words) {
                    model.postMessage({
